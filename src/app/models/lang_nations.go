...
func LangNationsList(page int, limit int, keywords string) *[]LangNations {
...
func (a *LangNations) AddNations() bool {
...
func GetNationsById(id string) *LangNations {
...
func GetOneNationsIsDefault() bool {
	...
	_, err := databases.Orm.Cols("is_default").Update(nations,LangNations{IsDefault: true})
	if err != nil {
		fmt.Println(err.Error())
		return false
	}
...
func GetOpenNationsList() *[]LangNations {
	lang := new([]LangNations)
